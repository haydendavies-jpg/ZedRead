...
async def list_products(
    ...
    Returns:
        list[ProductListItem]: Products ordered by display_order then name, each
            ...
            reporting_group_name, comma-joined modifier_names, and resolved tax_name.
    """
    ...
    return [
        ...
        for product, category_name, category_color, reporting_group_id, reporting_group_name, modifier_names, tax_name in rows
    ]
